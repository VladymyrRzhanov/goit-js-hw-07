...
import { headerRefs } from "./header";

const header = headerRefs()
const refs = getRefs();
...
console.log(header.homeBgcContainer.classList.value)

if (header.homeBgcContainer.classList.contains('home-bgc-container')) {
  console.log('libr')
  movieSearch.fetchPopularMovie().then(renderMovie);
} else {
  return
